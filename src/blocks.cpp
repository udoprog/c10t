...
void mc::initialize_constants() {
  ...
  mc::MaterialColor[mc::Water] = new Color(38,92,255,255);//0xd0);
  mc::MaterialColor[mc::StationaryWater] = new Color(38,92,255,255);//80);
  ...
  mc::MaterialColor[mc::Leaves] = new Color(60,192,41,255);//120);
