...
namespace mc {
  ...
  void initialize_constants() {
    ...
    MaterialName[NetherBrick] = "Nether Brick";
    MaterialName[NetherBrickFence] = "Nether Brick Fence";
    MaterialName[NetherBrickStairs] = "Nether Brick Stairs";
    MaterialName[NetherWart] = "Nether Wart";
    ...
    MaterialColor[Mycelium] = color(104,97,110,255);
    MaterialColor[LilyPad] = color(12,95,20,255);
    MaterialColor[NetherBrick] = color(50,22,28,255);
    MaterialColor[NetherBrickFence] = color(50,22,28,200);
    MaterialColor[NetherBrickStairs] = MaterialColor[NetherBrickStairs];
    MaterialColor[NetherWart] = color(129,8,10,255);
    ...
    MaterialSideColor[Mycelium] = color(MaterialColor[Mycelium]);
    MaterialSideColor[LilyPad] = color(MaterialColor[LilyPad]);
    MaterialSideColor[NetherBrick] = color(MaterialColor[NetherBrick]);
    MaterialSideColor[NetherBrickFence] = color(MaterialColor[NetherBrickFence]);
    MaterialSideColor[NetherBrickStairs] = color(MaterialColor[NetherBrickStairs]);
    MaterialSideColor[NetherWart] = color(MaterialColor[NetherWart]);
