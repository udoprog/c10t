...
namespace mc {
  ...
  void initialize_constants() {
    ...
    MaterialName[RedCloth] = "RedCloth";
    MaterialName[OrangeCloth] = "OrangeCloth";
    MaterialName[YellowCloth] = "YellowCloth";
    MaterialName[LimeCloth] = "LimeCloth";
    MaterialName[GreenCloth] = "GreenCloth";
    MaterialName[AquaGreenCloth] = "AquaGreenCloth";
    MaterialName[CyanCloth] = "CyanCloth";
    MaterialName[BlueCloth] = "BlueCloth";
    MaterialName[PurpleCloth] = "PurpleCloth";
    MaterialName[IndigoCloth] = "IndigoCloth";
    MaterialName[VioletCloth] = "VioletCloth";
    MaterialName[MagentaCloth] = "MagentaCloth";
    MaterialName[PinkCloth] = "PinkCloth";
    MaterialName[BlackCloth] = "BlackCloth";
    MaterialName[GrayCloth] = "GrayCloth";
    MaterialName[WhiteCloth] = "WhiteCloth";
    ...
    MaterialColor[RedCloth] = color();
    MaterialColor[OrangeCloth] = color();
    MaterialColor[YellowCloth] = color();
    MaterialColor[LimeCloth] = color();
    MaterialColor[GreenCloth] = color();
    MaterialColor[AquaGreenCloth] = color();
    MaterialColor[CyanCloth] = color();
    MaterialColor[BlueCloth] = color();
    MaterialColor[PurpleCloth] = color();
    MaterialColor[IndigoCloth] = color();
    MaterialColor[VioletCloth] = color();
    MaterialColor[MagentaCloth] = color();
    MaterialColor[PinkCloth] = color();
    MaterialColor[BlackCloth] = color();
    MaterialColor[GrayCloth] = color(0xdf, 0xdf, 0xdf, 0xff);
    MaterialColor[WhiteCloth] = color();
    ...
    MaterialSideColor[RedCloth] = color(MaterialColor[RedCloth]);
    MaterialSideColor[OrangeCloth] = color(MaterialColor[OrangeCloth]);
    MaterialSideColor[YellowCloth] = color(MaterialColor[YellowCloth]);
    MaterialSideColor[LimeCloth] = color(MaterialColor[LimeCloth]);
    MaterialSideColor[GreenCloth] = color(MaterialColor[GreenCloth]);
    MaterialSideColor[AquaGreenCloth] = color(MaterialColor[AquaGreenCloth]);
    MaterialSideColor[CyanCloth] = color(MaterialColor[CyanCloth]);
    MaterialSideColor[BlueCloth] = color(MaterialColor[BlueCloth]);
    MaterialSideColor[PurpleCloth] = color(MaterialColor[PurpleCloth]);
    MaterialSideColor[IndigoCloth] = color(MaterialColor[IndigoCloth]);
    MaterialSideColor[VioletCloth] = color(MaterialColor[VioletCloth]);
    MaterialSideColor[MagentaCloth] = color(MaterialColor[MagentaCloth]);
    MaterialSideColor[PinkCloth] = color(MaterialColor[PinkCloth]);
    MaterialSideColor[BlackCloth] = color(MaterialColor[BlackCloth]);
    MaterialSideColor[GrayCloth] = color(MaterialColor[GrayCloth]);
    MaterialSideColor[WhiteCloth] = color(MaterialColor[WhiteCloth]);
    ...
    MaterialModes[RedCloth] = Block;
    MaterialModes[OrangeCloth] = Block;
    MaterialModes[YellowCloth] = Block;
    MaterialModes[LimeCloth] = Block;
    MaterialModes[GreenCloth] = Block;
    MaterialModes[AquaGreenCloth] = Block;
    MaterialModes[CyanCloth] = Block;
    MaterialModes[BlueCloth] = Block;
    MaterialModes[PurpleCloth] = Block;
    MaterialModes[IndigoCloth] = Block;
    MaterialModes[VioletCloth] = Block;
    MaterialModes[MagentaCloth] = Block;
    MaterialModes[PinkCloth] = Block;
    MaterialModes[BlackCloth] = Block;
    MaterialModes[GrayCloth] = Block;
    MaterialModes[WhiteCloth] = Block;
