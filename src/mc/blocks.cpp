...
namespace mc {
  ...
  void initialize_constants() {
    ...
    MaterialName[Observer] = "Observer";
    MaterialName[ShulkerBoxWhite] = "ShulkerBoxWhite";
    MaterialName[ShulkerBoxOrange] = "ShulkerBoxOrange";
    MaterialName[ShulkerBoxMagenta] = "ShulkerBoxMagenta";
    MaterialName[ShulkerBoxLightBlue] = "ShulkerBoxLightBlue";
    MaterialName[ShulkerBoxYellow] = "ShulkerBoxYellow";
    MaterialName[ShulkerBoxLime] = "ShulkerBoxLime";
    MaterialName[ShulkerBoxPink] = "ShulkerBoxPink";
    MaterialName[ShulkerBoxGray] = "ShulkerBoxGray";
    MaterialName[ShulkerBoxLightGray] = "ShulkerBoxLightGray";
    MaterialName[ShulkerBoxCyan] = "ShulkerBoxCyan";
    MaterialName[ShulkerBoxPurple] = "ShulkerBoxPurple";
    MaterialName[ShulkerBoxBlue] = "ShulkerBoxBlue";
    MaterialName[ShulkerBoxBrown] = "ShulkerBoxBrown";
    MaterialName[ShulkerBoxGreen] = "ShulkerBoxGreen";
    MaterialName[ShulkerBoxRed] = "ShulkerBoxRed";
    MaterialName[ShulkerBoxBlack] = "ShulkerBoxBlack";
    ...
    set_color(Observer, 0, get_color(Dispenser));
    set_color(ShulkerBoxWhite, 0, color(205, 210, 210, 255));
    set_color(ShulkerBoxOrange, 0, color(228, 104, 9, 255));
    set_color(ShulkerBoxMagenta, 0, color(168, 52, 158, 255));
    set_color(ShulkerBoxLightBlue, 0, color(46, 156, 206, 255));
    set_color(ShulkerBoxYellow, 0, color(241, 182, 27, 255));
    set_color(ShulkerBoxLime, 0, color(94, 163, 22, 255));
    set_color(ShulkerBoxPink, 0, color(221, 114, 150, 255));
    set_color(ShulkerBoxGray, 0, color(56, 59, 63, 255));
    set_color(ShulkerBoxLightGray, 0, color(117, 117, 108, 255));
    set_color(ShulkerBoxCyan, 0, color(20, 116, 130, 255));
    set_color(ShulkerBoxPurple, 0, color(148, 103, 148, 255));
    set_color(ShulkerBoxBlue, 0, color(42, 44, 135, 255));
    set_color(ShulkerBoxBrown, 0, color(103, 64, 35, 255));
    set_color(ShulkerBoxGreen, 0, color(76, 96, 32, 255));
    set_color(ShulkerBoxRed, 0, color(138, 30, 29, 255));
    set_color(ShulkerBoxBlack, 0, color(23, 24, 28, 255));
    ...
    MaterialModes[Observer] = Block;
    MaterialModes[ShulkerBoxWhite] = Block;
    MaterialModes[ShulkerBoxOrange] = Block;
    MaterialModes[ShulkerBoxMagenta] = Block;
    MaterialModes[ShulkerBoxLightBlue] = Block;
    MaterialModes[ShulkerBoxYellow] = Block;
    MaterialModes[ShulkerBoxLime] = Block;
    MaterialModes[ShulkerBoxPink] = Block;
    MaterialModes[ShulkerBoxGray] = Block;
    MaterialModes[ShulkerBoxLightGray] = Block;
    MaterialModes[ShulkerBoxCyan] = Block;
    MaterialModes[ShulkerBoxPurple] = Block;
    MaterialModes[ShulkerBoxBlue] = Block;
    MaterialModes[ShulkerBoxBrown] = Block;
    MaterialModes[ShulkerBoxGreen] = Block;
    MaterialModes[ShulkerBoxRed] = Block;
    MaterialModes[ShulkerBoxBlack] = Block;
